...
<div class="flex min-h-screen relative z-10">
    ...
    <aside class="w-64 bg-[#0B3D2E] text-[#FDFBF7] fixed h-screen flex flex-col shadow-sm z-50">
        <div class="px-6 py-6 border-b border-white/10">
            ...
            <p class="text-[10px] font-medium text-white/50 uppercase tracking-widest mt-1">Super Admin</p>
        </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        ...
                        <div x-show="open" x-transition.origin.top.right
                            ...
                            <a href="{{ route('admin.profile') }}" class="flex items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-[#0B3D2E] transition">
                            ...
                            <div class="border-t border-gray-100 mt-1 pt-1">
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="w-full flex items-center gap-2.5 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 text-left transition">
