...
<div class="flex min-h-screen">
    ...
    {{-- SIDEBAR FINANCE — struktur & menu khusus role Finance --}}
    <aside class="w-72 bg-white sidebar-border fixed h-screen flex flex-col">
        <div class="px-8 py-6 border-b border-black/5">
            ...
            <p class="text-[11px] font-bold text-on-surface-variant/50 uppercase tracking-widest mt-1">Modul Finance</p>
        </div>

        <nav class="flex-1 px-4 pt-6 space-y-1 overflow-y-auto pb-8">

            <x-nav-link route="finance.dashboard">
                <span class="material-symbols-outlined text-[20px]">dashboard</span>
                Dashboard
            </x-nav-link>

            <x-nav-link route="finance.reimbursement.index">
                <span class="material-symbols-outlined text-[20px]">receipt_long</span>
                Verifikasi Reimbursement
            </x-nav-link>

            <x-nav-link route="finance.payroll.index">
                <span class="material-symbols-outlined text-[20px]">fact_check</span>
                Approval Payroll
            </x-nav-link>

            <x-nav-link route="finance.export.index">
                <span class="material-symbols-outlined text-[20px]">upload_file</span>
                Export Bank Transfer
            </x-nav-link>

            <x-nav-link route="finance.disbursement.index" active="finance.disbursement.*">
                    ...
                    <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                        <button @click="open = !open" class="flex items-center gap-3 group">
                            <div class="text-right hidden sm:block">
                                <p class="text-sm font-bold text-on-surface leading-tight">Rina Kartika</p>
                                <p class="text-[10px] text-on-surface-variant/60 font-bold uppercase tracking-wide">Finance Staff</p>
                            </div>
                            <img src="https://i.pravatar.cc/40?img=32" alt="Foto profil"
