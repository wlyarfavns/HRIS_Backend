    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-72 bg-white sidebar-border fixed h-screen flex flex-col">
            <div class="px-8 py-6 border-b border-black/5">
                ...
                <p class="text-[11px] font-bold text-on-surface-variant/50 uppercase tracking-widest mt-1">Modul Finance
                </p>
            </div>
                            ...
                            <button @click="open = !open" class="flex items-center gap-3 group">
                                <div class="text-right hidden sm:block">
                                    ...
                                    <p class="text-[10px] text-on-surface-variant/60 font-bold uppercase tracking-wide">
                                        {{ auth()->user()->getRoleNames()->first() ?? 'Finance Staff' }}
                                    </p>
                                </div>
                                <img src="{{ auth()->user()->avatar_url ?? 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->name) . '&background=0B3D2E&color=fff' }}"
